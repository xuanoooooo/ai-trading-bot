...
## 🔥 最新更新 v2.5.3 (2025-11-04)

**提示词优化 + 夏普比率功能**

✅ **英文提示词 + 中文输出**：节省60-70% tokens，每天约节省100万tokens  
✅ **夏普比率功能**：完整计算和传输，AI根据表现自动调整策略  
✅ **性能指标完善**：与Go版本对齐，最大化夏普比率为核心目标  
✅ **成本大幅降低**：系统提示词优化，每月节省约$2.1  
✅ **策略自动优化**：根据夏普比率自动调整交易频率和风险控制

---

**v2.5.2更新 - K线周期优化**

✅ **主K线从5分钟优化为30分钟**（24根=12小时历史）  
✅ **形态识别更可靠**：30分钟级别减少噪音，过滤假突破  
✅ **完美匹配持仓策略**：20分钟最小持仓与30分钟K线更匹配  
✅ **历史覆盖更长**：从2小时扩展到12小时，更好把握趋势  
🔧 **修复ATR标签错误**：各币种5分钟K线的ATR错误标记为15分钟，已修正

**v2.5.1更新 - 提示词优化**

✅ **首要遵守原则**：不知道怎么办就不办  
✅ **数据序列说明**：明确时间顺序（最旧→最新），防止AI误判趋势  
✅ **持仓时间约束**：最小持仓≥20分钟，减少手续费磨损  
✅ **信号置信度参考**：权重排序，矛盾信号有依据  
✅ **提示可能存在假突破**：假背离、成交量萎缩预警  
✅ **开仓自我检查**：3个问题强制确认，提高开仓质量
