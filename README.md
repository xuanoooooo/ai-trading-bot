...
### ✨ **v2.0.2 (2025-10-29) - 多时段分析优化**
- 📊 **时间序列说明优化** - 明确标注所有数据"从旧→新"顺序，避免AI混淆
- 📈 **周期作用说明** - 新增【数据周期说明】板块：
  - 15分钟周期（短期）：快速反应市场变化，捕捉短期机会
  - 历史16根K线（4小时）：观察价格形态和趋势演变
- 🎯 **提升AI理解** - 帮助AI更清楚每个时间周期的作用和意义
- ✅ **完整验证** - 确保AI能准确理解数据时间顺序和趋势演变

### 🐛 **v2.0.1 (2025-10-29) - Bug修复与体验优化**
- 🔧 **修复.env加载路径** - 解决从src目录运行时无法找到.env的问题
- 🔧 **修复语法错误** - 修正第376行缩进错误
- ✨ **启动脚本增强** - 支持系统Python3，无需虚拟环境（设置`USE_VENV=false`）
- 🎯 **智能环境检查** - 自动选择python/python3，更友好的错误提示
- ✅ **测试验证** - 完整测试通过（API连接、程序启动、AI决策）
